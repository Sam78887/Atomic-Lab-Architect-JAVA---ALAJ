...
private void generateConfigAndValence(int n) {
    ...
    public static void main(String[] args) {
        ...
        while (choice.equalsIgnoreCase("y")) {
            ...
            // 4. Composition & Structural Details
            System.out.println("\n--- Mass Composition ---");
            ...
            // 6. Bond Analysis Block (Only for Compounds)
            if (secondary != null) {
                System.out.println("\n--- Bond Analysis ---");
            ...
            // 7. Multi-Center Geometry (Accessible to all)
            if (totalAtoms >= 1) {
                ...
                if (totalAtoms == 1) {
                    ...
                    if (counts.containsKey("O") && counts.containsKey("H")) {
                        ...
                        predictGeometry(4, 2); // Steric 4, LP 2 = Bent
                    }
                }
            }
